...
<head>
    ...
    <style>
        ...
        .footer { margin-top: 30px; font-size: 12px; color: #999999; line-height: 1.5; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <p class="text">
            Kamu menerima email ini karena kami mendapat permintaan untuk reset password akun AuVerse kamu. 
            Klik tombol di bawah ini untuk membuat password baru.
        </p>
        
        <a href="{{ $url }}" class="btn" style="color: white;">Reset Password Sekarang</a>
        
        <p class="footer">
            Link reset password ini akan kadaluarsa dalam 60 menit.<br><br>
            Kalau tombol di atas nggak bisa diklik, *copy-paste* link ini di browser kamu: <br>
            <a href="{{ $url }}" style="color: #7B4DFF;">{{ $url }}</a>
            <br><br>
            Jika kamu tidak pernah meminta reset password, abaikan saja email ini. Akun kamu tetap aman.
        </p>
    </div>
</body>
</html>